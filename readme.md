...
1. The parser license should allow it to be used in a closed-source and redistributable commercial product
...
For example, [JavaScriptExtractor](http://git.pmease.com/gitplex/jsymbol/files?revision=master&path=src/main/java/com/gitplex/jsymbol/javascript/JavaScriptExtractor.java) works on the AST generated by [sonarqube javascript parser](https://github.com/SonarSource/sonar-javascript/tree/master/javascript-frontend).
